...
const Card = ({ title, title_english, image, year }: AnimeType) => {
  return (
    <div className='w-full h-60 lg:h-96 relative group overflow-hidden inline-block'>
      <Image
        priority={true}
        src={image}
        alt='Anime Image'
        className='object-fill h-full w-full absolute group-hover:scale-125 transition-all duration-500'
        width={800}
        height={800}
      />
